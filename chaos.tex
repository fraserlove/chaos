...
\begin{exmp}[Tent Map] \label{exmp:tent-map}
    ...
    \begin{figure}[h]
        ...
        \caption{Logistic map $T_s$ with $s = \frac{7}{4}$.}
        \label{fig:tent_1.75}
    \end{figure}
\end{exmp}
