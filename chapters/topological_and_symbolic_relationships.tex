...
\section{Symbolic Dynamics and the Shift Map} \label{sec:symbolic-dynamics}
...
\begin{thm}[Sharkovsky's Realisation Theorem] \label{thm:sharkovsky-realisation-theorem}
    ...
    \begin{proof}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=4cm]{truncated_tent}
